...
- Statement freezes: theory/STATEMENT_FREEZE_1.0.2.md — the frozen wording of every shared
  statement, with the numbered changes (N-blocks) and their reasons, all rounds appended.
- Author sign-off: docs/BLUEPRINT_HUMAN_REVIEW_1.0.2.md — all 31 F/M Blueprint nodes read by
