# p3_covol_balls_r19.sage -- R19 Track B PRODUCER BALLS (input A of the R19 certificate; NOT the certificate itself).
# Mathematics and code identical to sage/r18_trackB/p3_covol_cert_r18.sage (the v2 producer) except the output name / format tag.
# The R19 certificate certificates/p3/D3_cert_r19.json is GENERATED by tools/gen_p3_cert_r19.py as the outward hull (widened x2)
# of these producer balls and of the READ-ONLY recomputation scripts/verify_p3_readonly.sage --out (input B): hw 882-892, ERRATA_R19 E19-1.
...
OUT = os.environ.get("P3_OUT", "sage/r19_trackB/p3_covol_balls_r19.json")
...
out = {"format_version": "p3_covol_balls_r19_producer", "produced_by": "sage/r19_trackB/p3_covol_balls_r19.sage", "prec_bits": int(PREC),
...
src = open("sage/r19_trackB/p3_covol_balls_r19.sage", "rb").read()
out["script_sha256"] = hashlib.sha256(src).hexdigest()
json.dump(out, open(OUT, "w"), indent=1)
print("R19 P3 COVOL BALLS DONE ; rows", len(out["rows"]), "; prec", PREC, "; script sha256", out["script_sha256"][:12])
