# r5_escalate_cls1 - specified escalation (BKZ-40 -> BKZ-50 + top-24 pairwise combos)
...
def esc_prime(l):
    ...
    for ci,g in enumerate(fac):
        ...
        B=matrix(ZZ,emb).LLL().BKZ(block_size=40)
        B=B.BKZ(block_size=50)
    ...
    sys.stdout.flush()
for l in [1000000513, 1000000000000000000000000000018049]:
