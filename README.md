...
- Paper: `paper/draft/main_1.0.2.pdf` (39 pages) — source `main_1.0.2.tex`
- Blueprint: `blueprint/blueprint_1.0.2.pdf` (34 pages) — every F/M node with a complete human-readable proof; source `blueprint/src/`
...
Every claim carries a label (definitions and per-claim checking instructions: `TRUST.md`; claim map: `CORRESPONDENCE.csv`, generated from `docs/CLAIMS_1.0.2.yaml`):
...
- **M (Manuscript)** — proved in the paper and, verbatim, in the Blueprint; not machine-checked; all 31 F/M nodes carry the author's signed review (`docs/BLUEPRINT_HUMAN_REVIEW_1.0.2.md`)
