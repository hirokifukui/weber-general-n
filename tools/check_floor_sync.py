...
Asserts that the T-route threshold is the SAME piecewise function of n in every medium:
  ...
  paper     paper/draft/main_1.0.0.tex     definition of \\barT (17·2^n for n=2, 33·2^n for n>=3)
...
# 4 paper
need('paper/draft/main_1.0.0.tex', r'\\barT:=17\\cdot2\^n\$ for \$n=2\$ and \$\\barT:=33\\cdot2\^n\$ for \$n\\ge3\$', 'paper \\barT definition')
# 5 proof text
...
for p in ('paper/draft/main_1.0.0.tex', 'proofs/thm_cert.tex', 'blueprint/src/content.tex', 'theory/STATEMENT_FREEZE_1.0.0.md', 'README.md', 'TRUST.md', 'lean/README_lean.md'):
