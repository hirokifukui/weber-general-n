...
# not gate failures. The report is written to docs/BLUEPRINT_PROOF_REPORT_1.0.1.md (generated; do not edit). The gates above assert
...
if '--report' in sys.argv:
    ...
    out=['# BLUEPRINT_PROOF_REPORT_1.0.1 — generated by blueprint/check_graph.py --report (do not edit)','',
    ...
    rp=os.path.join(os.path.dirname(os.path.abspath(__file__)),'..','docs','BLUEPRINT_PROOF_REPORT_1.0.1.md')
    open(rp,'w',encoding='utf-8').write('\n'.join(out)+'\n')
    print('PROOF REPORT: F %d ; M %d ; SHORT %d (warning) ; written docs/BLUEPRINT_PROOF_REPORT_1.0.1.md'%(nF,nM,nshort))
